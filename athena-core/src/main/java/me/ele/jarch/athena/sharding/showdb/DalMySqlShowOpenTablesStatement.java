...
public class DalMySqlShowOpenTablesStatement extends DalShowStatementRewriter {
    private MySqlShowOpenTablesStatement sqlStmt = null;
    ...
    @Override public void setSqlStmt(SQLObject e) {
        this.sqlStmt = (MySqlShowOpenTablesStatement) e;
    }
