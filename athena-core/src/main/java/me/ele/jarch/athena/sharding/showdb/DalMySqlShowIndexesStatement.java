...
public class DalMySqlShowIndexesStatement extends DalShowStatementRewriter {
    private MySqlShowIndexesStatement sqlStmt = null;
    ...
    @Override public void setSqlStmt(SQLObject e) {
        this.sqlStmt = (MySqlShowIndexesStatement) e;
    }
