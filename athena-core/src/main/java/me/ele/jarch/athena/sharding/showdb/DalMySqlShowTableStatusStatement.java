...
public class DalMySqlShowTableStatusStatement extends DalShowStatementRewriter {
    private MySqlShowTableStatusStatement sqlStmt = null;
    ...
    @Override public void setSqlStmt(SQLObject e) {
        this.sqlStmt = (MySqlShowTableStatusStatement) e;
    }
