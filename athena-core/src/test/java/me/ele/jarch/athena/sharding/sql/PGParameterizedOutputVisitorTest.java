...
public class PGParameterizedOutputVisitorTest {
    String selectSql =
    ...
    @BeforeClass public void init() {
        ...
        SQLStatementParser parser2 =
            SQLParserUtils.createSQLStatementParser(insertSelectSql, JdbcUtils.POSTGRESQL);
