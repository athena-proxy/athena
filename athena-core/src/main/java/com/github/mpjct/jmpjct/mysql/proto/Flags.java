...
public class Flags {
    ...
    public static final int MODE_READ_HANDSHAKE = 1;
    ...
    public static final int MODE_READ_AUTH_RESULT = 5;
    ...
    public static final int MODE_READ_QUERY_RESULT = 9;
    ...
    public static final int SERVER_STATUS_CLEAR_SET =
        (SERVER_QUERY_NO_GOOD_INDEX_USED | SERVER_QUERY_NO_INDEX_USED | SERVER_MORE_RESULTS_EXISTS
            | SERVER_STATUS_METADATA_CHANGED | SERVER_QUERY_WAS_SLOW | SERVER_STATUS_DB_DROPPED
    ...
    public static final int CLIENT_ALL_FLAGS =
        (CLIENT_LONG_PASSWORD | CLIENT_FOUND_ROWS | CLIENT_LONG_FLAG | CLIENT_CONNECT_WITH_DB
            ...
            | CLIENT_PS_MULTI_RESULTS | CLIENT_SSL_VERIFY_SERVER_CERT | CLIENT_REMEMBER_OPTIONS
    ...
    public static final int SHUTDOWN_WAIT_CRITICAL_BUFFERS =
        (MYSQL_SHUTDOWN_KILLABLE_UPDATE << 1) + 1;
