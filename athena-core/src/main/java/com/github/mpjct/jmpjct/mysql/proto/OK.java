...
public class OK extends Packet {
    private static final byte[] DEFAULT_OK_PACKET_BYTES =
        new byte[] {7, 0, 0, 2, 0, 0, 0, 2, 0, 0, 0};
    private static final byte[] OK_PACKET_BYTES = new byte[] {7, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0};
    ...
    @Override public String toString() {
        return "OK [affectedRows=" + affectedRows + ", lastInsertId=" + lastInsertId
            + ", statusFlags=" + statusFlags + ", warnings=" + warnings + "]";
    }

    public static byte[] getDefaultOkPacketBytes() {
        return DEFAULT_OK_PACKET_BYTES;
    }

    public static byte[] getOkPacketBytes() {
        return OK_PACKET_BYTES;
    }
}
