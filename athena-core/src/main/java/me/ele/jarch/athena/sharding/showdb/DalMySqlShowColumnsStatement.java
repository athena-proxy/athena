...
public class DalMySqlShowColumnsStatement extends DalShowStatementRewriter {
    private MySqlShowColumnsStatement sqlStmt = null;
    ...
    @Override public void setSqlStmt(SQLObject e) {
        this.sqlStmt = (MySqlShowColumnsStatement) e;
    }
